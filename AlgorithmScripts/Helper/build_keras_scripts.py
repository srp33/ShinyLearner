...
createScripts("Classification", packagePath, "keras_c_resnet_template", "resnet", None, resnet, {"layer_width": ["16", "32"], "layers": ["50", "100"], "dropout": ["0.5"], "regularization": ["0.1", "0.01", "0.001"], "activation": ["selu"], "learning_rate": ["0.001"], "epochs": ["100", "10", "500"]}, summaryDict)
