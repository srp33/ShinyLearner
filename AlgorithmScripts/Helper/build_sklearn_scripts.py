...
createScripts("Classification", packagePath, "sklearn_c_template", "adaboost", None, adaboost, {"base_estimator": baseEstimatorOptions, "n_estimators": numEstimatorOptions, "algorithm": boostAlgorithmOptions})
...
createScripts("Classification", packagePath, "sklearn_c_template", "bagging", None, bagging, {"base_estimator": baseEstimatorOptions, "n_estimators": numEstimatorOptions, "bootstrap": bootstrapOptions, "oob_score": oobScoreOptions})
...
createScripts("Classification", packagePath, "sklearn_c_template", "gradient_boosting", None, gradient_boosting, {"loss": lossOptions, "n_estimators": numEstimatorOptions, "criterion": ['friedman_mse'], "min_samples_split": [2], "min_samples_leaf": [1], "min_weight_fraction_leaf": [0.0], "max_depth": [3], "min_impurity_split": [1e-07], "max_features": [None], "max_leaf_nodes": [None]})
...
createScripts("Classification", packagePath, "sklearn_c_template", "knn", None, knn, {"n_neighbors": neighborOptions, "weights": weightOptions, "p": pOptions})
...
createScripts("Classification", packagePath, "sklearn_c_template", "lda", None, lda, {"solver": ["svd", "lsqr", "eigen"], "tol": [0.0001]})
...
createScripts("Classification", packagePath, "sklearn_c_template", "logistic_regression", None, logistic_regression, {"penalty": ['l2', "l1"], "dual": [False, True], "tol": [0.0001], "C": cOptions, "class_weight": classWeightOptions, "solver": ['liblinear', 'newton-cg', 'lbfgs', 'sag'], "max_iter": [100], "multi_class": ['ovr']})
...
createScripts("Classification", packagePath, "sklearn_c_template", "multilayer_perceptron", None, multilayer_perceptron, {"hidden_layer_sizes": [(100, ), (200, ), (500, )], "activation": ['relu', 'identity', 'logistic', 'tanh'], "solver": ['adam', 'lbfgs', 'sgd'], "alpha": [0.0001], "learning_rate": ['constant', 'invscaling', 'adaptive'], "max_iter": [200], "tol": [0.0001], "early_stopping": [False, True]})
...
createScripts("Classification", packagePath, "sklearn_c_template", "sgd", None, sgd, {"penalty": ['l2', 'l1', 'elasticnet'], "alpha": [0.0001], "n_iter": [5, 10, 20], "epsilon": [0.1], "learning_rate": ['optimal', 'constant', 'invscaling'], "class_weight": classWeightOptions})
...
createScripts("Classification", packagePath, "sklearn_c_template", "svm", None, svm, {"C": cOptions, "kernel": ['rbf', 'linear', 'poly', 'sigmoid'], "shrinking": [True, False], "tol": [0.001], "class_weight": classWeightOptions})
...
createScripts("FeatureSelection", packagePath, "sklearn_f_template", "anova", "score", anova, {})

mutual_info = "score = 1 - mutual_info_classif(train_X, train_y, n_neighbors={n_neighbors})"
createScripts("FeatureSelection", packagePath, "sklearn_f_template", "mutual_info", "score", mutual_info, {"n_neighbors": [3]})
...
createScripts("FeatureSelection", packagePath, "sklearn_f_template", "random_forest_rfe", "rfe", random_forest_rfe, {"step": [0.1]})
...
createScripts("FeatureSelection", packagePath, "sklearn_f_template", "random_logistic_regression", "coef", random_logistic_regression, {"C": [1], "scaling": [0.5], "sample_fraction": [0.75], "n_resampling": [200], "selection_threshold": [0.25], "tol": [0.001]})

svm_rfe = "selector = RFE(SVC(random_state=R_SEED, kernel='linear'), n_features_to_select=1, step={step})"
createScripts("FeatureSelection", packagePath, "sklearn_f_template", "svm_rfe", "rfe", svm_rfe, {"step": [0.1]})
