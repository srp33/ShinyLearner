...
extra_trees = "clf = ExtraTreesClassifier(n_estimators={n_estimators}, criterion='{criterion}', max_depth={max_depth}, min_samples_split={min_samples_split}, min_samples_leaf={min_samples_leaf}, min_weight_fraction_leaf={min_weight_fraction_leaf}, max_features={max_features}, max_leaf_nodes={max_leaf_nodes}, min_impurity_split={min_impurity_split}, bootstrap={bootstrap}, oob_score={oob_score}, class_weight={class_weight}, n_jobs={n_jobs}, random_state=R_SEED, verbose=0, warm_start=False)"
...
sgd = "clf = SGDClassifier(loss='modified_huber', penalty='{penalty}', alpha={alpha}, l1_ratio=0.15, fit_intercept=True, n_iter={n_iter}, shuffle=True, verbose=0, epsilon={epsilon}, n_jobs={n_jobs}, learning_rate='{learning_rate}', eta0=0.0, power_t=0.5, class_weight={class_weight}, warm_start=False, average=False, random_state=R_SEED)"
