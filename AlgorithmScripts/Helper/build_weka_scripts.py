...
createScripts("Classification", packagePath, "weka_c_template", "BayesNet", None, BayesNet, {"estimator": ["weka.classifiers.bayes.net.estimate.SimpleEstimator -- -A 0.5", "weka.classifiers.bayes.net.estimate.BMAEstimator -- -A 0.5"], "searchAlgorithm": ["weka.classifiers.bayes.net.search.local.K2 -- -P 1 -S BAYES", "weka.classifiers.bayes.net.search.local.HillClimber -- -P 1 -S BAYES", "weka.classifiers.bayes.net.search.local.RepeatedHillClimber -- -U 10 -A 1 -P 1 -S BAYES"]}, summaryDict)
