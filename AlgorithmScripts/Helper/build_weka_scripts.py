...
##createScript("FeatureSelection", "weka_f_template", "SVMRFE", "default", 'weka.attributeSelection.SVMAttributeEval -X 5 -Y 10 -Z 5 -P 1.0E-25 -T 1.0E-10 -C 1.0 -N 0 weka.attributeSelection.SVMAttributeEval -X 1 -Y 0 -Z 0 -P 1.0E-25 -T 1.0E-10 -C 1.0 -N 2 -s \"weka.attributeSelection.Ranker -T -1.7976931348623157E308 -N -1\"')
createScript("FeatureSelection", "weka_f_template", "SVMRFE", "default", 'weka.attributeSelection.SVMAttributeEval -X 1 -Y 0 -Z 0 -P 1.0E-25 -T 1.0E-10 -C 1.0 -N 2 -s \"weka.attributeSelection.Ranker -T -1.7976931348623157E308 -N -1\"')
